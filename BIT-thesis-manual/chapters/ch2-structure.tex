...
\subsection{封面和标题}
在主控文件demo.txt中填写论文的相应信息。


中文封面信息：论文标题、作者姓名、学院名称、指导教师、答辩委员会主席、申请学位、学科专业、学位授予单位以及论文答辩日期。

英语封面信息：English Title， Candidate Name， School or Department，Faculty Mentor，Chair, Thesis Committee，Degree Applied，Major，Degree by，The Data of Defence

\begin{lstlisting}[language={TeX}, caption={封面内容}]
% 中文封面内容
...
\begin{lstlisting}[language={TeX}, caption={中英文摘要}]
\begin{abstract}
	本文 ...
\keywords { 形状记忆；聚氨酯 }
\end{abstract}
