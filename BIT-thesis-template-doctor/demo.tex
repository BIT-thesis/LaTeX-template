%%==================================================
%% demo.tex for BIT Doctor Thesis
...
%\documentclass[cs4size, a4paper, cs4size, twoside]{bitdoctor-xetex}
% 单面打印（注意字号设置）
\documentclass[cs4size, a4paer, cs4size, oneside, openany]{bitdoctor-xetex}
